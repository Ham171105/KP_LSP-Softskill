...
<head>
    ...
    <title>Sertifikat Kepemimpinan - {{ $certificate->certificate_number }}</title>
    <style>
        body {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="page front-page">
        ...
        <div class="subtitle">Bidang Kepemimpinan</div>
        
        <div class="given-to">Diberikan kepada:</div>
        <div class="name">{{ $certificate->participant_name }}</div>
        
        <div class="desc">
            Telah menyelesaikan pelatihan dan asesmen pada bidang <strong>Kepemimpinan (Leadership)</strong> dengan predikat <em>Sangat Memuaskan</em>.
        </div>
    ...
    <div class="page back-page">
        <h2>Transkrip Kompetensi - Kepemimpinan</h2>
        <table>
            <thead>
                <tr>
                    <th width="10%">No</th>
            ...
            <tbody>
                <tr>
                    <td>1</td>
                    <td>Menerapkan Keterampilan Komunikasi Kepemimpinan</td>
                    <td>Kompeten</td>
                </tr>
                <tr>
                    <td>2</td>
                    <td>Mengelola Tim dan Delegasi Tugas</td>
                    <td>Kompeten</td>
                </tr>
                <tr>
                    <td>3</td>
