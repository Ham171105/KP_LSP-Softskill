...
<head>
    ...
    <title>Sertifikat Pemecahan Masalah - {{ $certificate->certificate_number }}</title>
    <style>
        body {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="page front-page">
        ...
        <div class="subtitle">Bidang Pemecahan Masalah</div>
        
        <div class="given-to">Diberikan kepada:</div>
        <div class="name">{{ $certificate->participant_name }}</div>
        
        <div class="desc">
            Telah menyelesaikan pelatihan dan asesmen pada bidang <strong>Pemecahan Masalah (Problem Solving)</strong> dengan predikat <em>Sangat Memuaskan</em>.
        </div>
    ...
    <div class="page back-page">
        <h2>Transkrip Kompetensi - Pemecahan Masalah</h2>
        <table>
            <thead>
                <tr>
                    <th width="10%">No</th>
            ...
            <tbody>
                <tr>
                    <td>1</td>
                    <td>Menganalisis Akar Permasalahan</td>
                    <td>Kompeten</td>
                </tr>
                <tr>
                    <td>2</td>
                    <td>Berpikir Kritis dan Kreatif</td>
                    <td>Kompeten</td>
                </tr>
                <tr>
                    <td>3</td>
                    <td>Mengimplementasikan Solusi yang Efektif</td>
                    <td>Kompeten</td>
                </tr>
            </tbody>
        </table>
